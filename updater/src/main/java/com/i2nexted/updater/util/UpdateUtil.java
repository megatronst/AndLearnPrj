...
public class UpdateUtil {
    private static final String TAG = "com.i2nexted.update";
    private static final String PREFS = "com.i2nexted.update.prefs";
    private static final String KEY_IGNORE = "com.i2nexted.update.prefs.ignore";
    private static final String KEY_UPDATE = "com.i2nexted.update.prefs.update";
    ...
    /**
     *文件校验，根据下载的apk文件的MD5码与后台返回的md5码进行对比校验文件是否有损坏的情况
     * */
